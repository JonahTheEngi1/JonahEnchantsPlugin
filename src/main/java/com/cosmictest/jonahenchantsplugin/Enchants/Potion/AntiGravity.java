    ...
    public static void enableEffects(Player player, int effectLevel) {
        ...
        switch (effectLevel) {
            case 1:
                ...
                break;
            case 2:
                player.addPotionEffect(new PotionEffect(PotionEffectType.JUMP, duration, 4, true, false));
                break;
            case 3:
                player.addPotionEffect(new PotionEffect(PotionEffectType.JUMP, duration, 6, true, false));
                break;
            default:
